...
interface WealthWiseSimpleWhiteProps extends React.SVGProps<SVGSVGElement> {}

const WealthWiseSimpleWhite: React.FC<WealthWiseSimpleWhiteProps> = (props) => (
  <svg
...
export default WealthWiseSimpleWhite;
